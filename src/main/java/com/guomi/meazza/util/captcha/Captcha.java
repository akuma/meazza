/* 
 * @(#)Captcha.java    Created on 2013-1-31
...
import com.guomi.meazza.util.captcha.background.BackgroundProducer;
import com.guomi.meazza.util.captcha.background.TransparentBackgroundProducer;
import com.guomi.meazza.util.captcha.noise.CurvedLineNoiseProducer;
import com.guomi.meazza.util.captcha.noise.NoiseProducer;
import com.guomi.meazza.util.captcha.text.DefaultTextProducer;
import com.guomi.meazza.util.captcha.text.DefaultWordRenderer;
import com.guomi.meazza.util.captcha.text.FishEyeGimpyRenderer;
import com.guomi.meazza.util.captcha.text.GimpyRenderer;
import com.guomi.meazza.util.captcha.text.TextProducer;
import com.guomi.meazza.util.captcha.text.WordRenderer;
 ...
 * 
 * @author simplecaptcha team
 * 
 */
public final class Captcha implements Serializable {

    private static final long serialVersionUID = -469074500945846251L;
    ...
    public static class Builder implements Serializable {
        ...
        private static final long serialVersionUID = 1897254543127018984L;

        private String _answer = StringUtils.EMPTY;
        ...
        /**
         * Generate the answer to the CAPTCHA using the given {@link TextProducer}.
         * 
         * @param txtProd
         */
        ...
        /**
         * Generate the answer to the CAPTCHA using the default {@link TextProducer}, and render it to the image using
        ...
        /**
         * Generate the answer to the CAPTCHA using the given {@link TextProducer}, and render it to the image using the
         * given {@link WordRenderer}.
         * 
         * @param txtProd
         * @param wRenderer
         */
